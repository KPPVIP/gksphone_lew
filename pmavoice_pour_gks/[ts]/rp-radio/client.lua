...
Radio.Labels = {        
	...
	{ "FRZL_RADIO_INPUT", "Entrez une fréquence" },
}
...
Radio.Commands = {
	{
		...
		Help = "Ouvrir la radio", -- Command help shown in chatbox when typing the command
		Params = {},
...
RegisterNetEvent("rp-radio:accessFrequence")
AddEventHandler("rp-radio:accessFrequence", function(value)
	local frequency = tonumber(value)
	if frequency ~= nil then
...
Citizen.CreateThread(function()
	...
	while true do
		...
		-- Init local vars
		local playerPed = PlayerPedId()
		local isActivatorPressed = IsControlJustPressed(0, radioConfig.Controls.Activator.Key) and GetLastInputMethod( 2 )
